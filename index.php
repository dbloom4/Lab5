...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="well">
                    ...
                    <p>Read more about Jerry on the <a href="jerrydai.php"> page here
                ...
                <div class="well">
                    ...
                    <p>Read more about Phillip on the <a href="philipkallinos.php"> page here </a></p>
                </div><!--closes well class-->
        ...
        <p>Read more about Daniella on the <a href="daniellabloom.php"> page here </a></p>
                </div><!--closes well class-->
